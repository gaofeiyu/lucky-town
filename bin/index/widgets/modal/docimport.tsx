...
export class DocImportModal extends React.Component<any, any>  {
        ...
        <Modal.Body>
          <div className="row">
            <div className="col-md-6 col-sm-6">
              <div className="btn btn-block btn-primary" type="button"><i className="fa fa-cloud-upload" />&nbsp;&nbsp;Postman </div>
          ...
          <div className="row">
            <div className="col-md-12 col-sm-12">
              <div className="btn btn-block btn-info" type="button" style={{ position: 'relative' }}>
